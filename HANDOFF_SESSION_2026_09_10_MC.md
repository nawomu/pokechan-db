...
| E2 | **実装中**: 味方を読む特性群(フレンドガード/テレパシー/プラマイ/そうだいしょう/おもてなし/きみょうなくすり/いやしのこころ/レシーバー/きょうせい/ベール3)指示書 scratchpad `spec_e2_ally_abilities.md` | — |
| E3 | **未着手**: ワイドガード/ファストガード/サイドチェンジ 指示書 scratchpad `spec_e3_ally_moves.md` | — |
