...
const WORD = [
  ...
  ['能力ランクは±N表記', '<b>能力ランクの増減は「{能力}+N / {能力}-N」で固定</b>(例「相手のこうげき-1、とくこう-1」「自分のこうげき+2」)。✗「〜が1段階さがる/あがる」。対象=こうげき・ぼうぎょ・とくこう・とくぼう・すばやさ・めいちゅう・かいひ すべて。複数能力でも<b>各能力に符号数値を繰り返す</b>。※「最大まで」(はらだいこ等 to_max)だけは数値でないので特例。<b>急所ランクは別ルール</b>(「ひとつ上がる」=和語数詞)。'],
